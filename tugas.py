...
class TestLogin(unittest.TestCase):
    ...
    def test_a_success_login(self):
        ...
        browser.find_element(
            By.XPATH, "/html/body/div/div[2]/form/input[1]").send_keys("danang@ymail.com")  # isi email
        time.sleep(1)
        browser.find_element(By.CSS_SELECTOR, "input#password").send_keys(
            "qwerty123")  # isi password
        time.sleep(1)
        # klik tombol sign in
    ...
    def test_c_failed_login_with_empty_email_and_password(self):
        ...
        time.sleep(3)
        browser.find_element(
            By.XPATH, "/html/body/div/div[2]/form/input[1]").send_keys("")  # isi email
        time.sleep(1)
        browser.find_element(By.CSS_SELECTOR, "input#password").send_keys(
            "")  # isi password
        time.sleep(1)
...
class TestSignUp(unittest.TestCase):
    ...
    def test_a_success_signup(self):
        ...
        time.sleep(1)
        browser.find_element(By.ID, "name_register").send_keys("DanangSupport")
        time.sleep(1)
        browser.find_element(By.ID, "email_register").send_keys(
            "danangsupport@ymail.com")
        time.sleep(1)
    ...
    def test_b_failed_signup_with_empty_name(self):
        # steps
        browser = self.browser  # buka web browser
        browser.get("http://barru.pythonanywhere.com/daftar")  # buka situs
        browser.maximize_window()
        ...
        time.sleep(1)
        browser.find_element(By.ID, "email_register").send_keys("danang@ymail.com")
        time.sleep(1)
        browser.find_element(By.ID, "password_register").send_keys("qwerty123")
        time.sleep(1)
        browser.find_element(By.ID, "signup_register").click()  # klik tombol sign up
    ...
    def test_c_failed_signup_with_empty_name_email_password(self):
        # steps
        browser = self.browser  # buka web browser
        browser.get("http://barru.pythonanywhere.com/daftar")  # buka situs
        browser.maximize_window()
    ...
    def test_c_failed_signup_with_empty_password(self):
        ...
        browser.find_element(By.ID, "signUp").click()  # klik tombol sign up
        time.sleep(1)
        browser.find_element(By.ID, "name_register").send_keys("danang")
        time.sleep(1)
        browser.find_element(By.ID, "email_register").send_keys("danang@ymail.com")
        time.sleep(1)
        browser.find_element(By.ID, "password_register").send_keys("")
